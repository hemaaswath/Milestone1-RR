"""
Phase 8: Streamlit Deployment - Fast-sharing Demo App

This is a single-process Python app for course demos and stakeholder previews.
It provides a beautiful interface for restaurant recommendations with Streamlit.
"""
...
def create_mock_recommendations(preferences):
    """Create mock recommendations when API is unavailable."""
    ...
    for i in range(top_k):
        recommendations.append({
            ...
            "rank": i + 1,
            "score": 0.95 - (i * 0.1),
            "explanation": f"This is a demo restaurant in {location} offering {cuisine} cuisine. Perfect for {budget} budget with excellent ratings and great service.",
            "location": location,
            "cuisines": cuisine,
            "rating": 4.5 - (i * 0.1),
...
def display_header():
    ...
    st.markdown('<div class="sub-header">Phase 8: Streamlit Demo App - Fast Sharing for Demos</div>', unsafe_allow_html=True)
    ...
    if api_healthy:
        ...
        st.warning("🟡 Backend API Offline - Using Demo Data")
        ...
        if submit_button:
            ...
            with st.spinner("🤖 AI is analyzing restaurants for you..."):
                ...
                if not recommendations_data:
                    ...
                    recommendations_data = create_mock_recommendations(preferences)
